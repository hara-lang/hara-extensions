...
const source = process.env.HARA_SQLITE_SOURCE
  ...
  : resolve(repository, "hara-runtime/extensions/db-sqlite-wasm");
const output = process.env.HARA_SQLITE_OUTPUT
  ? resolve(process.env.HARA_SQLITE_OUTPUT)
  : resolve(source, "target/package/db/sqlite/wasm/hta");
...
const packaged = await packageDbProvider({
  ...
  additionalAssets: [
    {
      source: resolve(source, "src/db/node/driver/sqlite_wasm.hal"),
      destination: "src/db/node/driver/sqlite_wasm.hal"
    },
    {
      source: resolve(web, "../node_modules/@sqlite.org/sqlite-wasm/node.mjs"),
      destination: "vendor/sqlite/node.mjs"
    },
    {
      source: resolve(web, "../node_modules/@sqlite.org/sqlite-wasm/sqlite-wasm/jswasm/sqlite3-node.mjs"),
      destination: "vendor/sqlite/sqlite-wasm/jswasm/sqlite3-node.mjs"
    },
    {
      source: resolve(web, "../node_modules/@sqlite.org/sqlite-wasm/sqlite-wasm/jswasm/sqlite3.wasm"),
